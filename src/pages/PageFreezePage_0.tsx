        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
            <div className="flex flex-row items-center justify-center gap-4 h-fit">
                <div className="flex flex-col items-center justify-center gap-2">
                    <p className="text-black text-center">JS controled</p>
                    <span>{progress}</span>
                    <Progress className="w-[80px]" value={progress} />
                </div>
                <div className="flex flex-col items-center justify-center gap-2">
                    <p className="text-black text-center">CSS button effect</p>
                    <Button >Test</Button>
                </div>
                <div className="flex flex-col items-center justify-center gap-2">
                    <p className="text-black text-center">CSS animate(cpu)</p>
            ...
            <div className="flex flex-row items-center justify-center gap-4 h-fit">
                <div className="flex flex-col items-center justify-center gap-2">
                    <p className="text-black text-center">CSS animate(gpu)</p>
                ...
                <div className="flex flex-col items-center justify-center gap-2">
                    <p className="text-black text-center">GIF</p>
            ...
            <div className="flex flex-col items-center justify-center mt-4 gap-4">
                ...
                <div className="flex flex-row items-center justify-center mt-4 gap-4">
                    <Button onClick={() => calc("main")} >Calc on Main thread</Button>
